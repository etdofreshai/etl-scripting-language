...
cc -std=c11 -Wall -Wextra -Werror runtime/test_vm.c runtime/etl_vm.c runtime/etl_string.c runtime/etl_dynarr.c runtime/etl_etlval.c -I runtime -o "$td/test_vm"
"$td/test_vm"
