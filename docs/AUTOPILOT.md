...
1. Finalize ETL v0 lexical grammar and syntax choices.
2. Create compiler-0 skeleton in a pragmatic host language.
3. Implement lexer/parser for a tiny function subset.
4. Emit C for a tiny program and run it.
