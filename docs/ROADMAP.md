...
> C/WAT/ASM, a
> 23-fixture c1 equiv corpus including local fixed i32 array sum, loop, and
> i8 array fixtures, and an 18-case shared C/ASM/WAT backend subset.
