...
> C/WAT/ASM, a
> 29-fixture c1 equiv corpus including Tier 2 typed bool/i8 locals plus local
> fixed i32 array sum, loop, i8 array, and struct fixtures, expanded c1
> C-path buffers for a self-compile probe, and an 18-case shared
