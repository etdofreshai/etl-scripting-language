...
| 4a    | done     | d8f76aa        |
| 4b    | done     | 625c740        |
| 5     | in progress (extern calls + 18-case backend subset + narrow i32 array indexing smoke) | -        |
| 6     | not started | -            |
| 7     | not started | -            |
| 8     | not started | -            |
| 9     | not started | -            |
...
- 5e: C emitter in ETL (smoke DONE; void + return-valued extern calls DONE; narrow i32 array indexing DONE at fa722e8)
- 5f: c0→c1 builds c1; c1 compiles fixture corpus; behavior-equivalent diff (next; narrow i32 constant-index array smoke landed, full array work remaining)
